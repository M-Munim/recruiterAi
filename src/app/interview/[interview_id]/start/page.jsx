            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-5'>
                <div className='bg-gray-100 h-[400px] rounded-lg border flex flex-col gap-3 items-center justify-center'>
                    <div className='relative'>
                        ...
                        <Image src="/aiGirl.jpeg" width={100} height={100} alt="ai" className='w-[60px] h-[60px] rounded-full object-cover' />
                ...
                <div className='bg-gray-100 h-[400px] rounded-lg border flex flex-col gap-3 items-center justify-center'>
                    <div className='relative'>
                        ...
                        <h2 className='text-2xl text-white p-3 px-5 rounded-full bg-blue-600'>{interviewInfo?.userName[0]}</h2>
